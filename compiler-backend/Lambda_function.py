...
def execute_python_code(code):
    ...
    output_capture = io.StringIO()  # Redirect standard output
...
def execute_java_code(code):
    try:
        print('this is the code that we have received', code) # Create a temporary Java source file
...
def execute_cpp_code(code):
    try:
        print('This is the code that we have recived:\n', code)    
